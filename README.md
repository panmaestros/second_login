...
One example of future requirement is to use a different salt encryption based on the user's country. To implement this new authentication rule please read the manual document `docs/FutureRules.rtf`
